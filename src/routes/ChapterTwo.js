    ...
    return (
      <div className="parallax">
        ...
        <div id="group5" className="parallax__group">
          <div className="parallax__layer parallax__layer--fore">
            <div className="box"><p>{text[this.state.avatar+"Ortsgruppe3"]}</p><p>Hier Spiel einfügen!</p></div>
          </div>
          <div className="parallax__layer parallax__layer--base">
          </div>
        </div>
        <div id="group6" className="parallax__group">
          ...
          <div className="parallax__layer parallax__layer--fore">
            <div className="box"><p>{text[this.state.avatar+"Ortsgruppe"]}</p><p>Hier Karte einfügen!</p></div>
          </div>
        </div>

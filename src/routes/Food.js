...
text["AnnaFood2"] = 'Nach drei Wochen ist das Zeltlager zu Ende und die Republikanerinnen und Republikaner fahren in alle Himmelsrichtungen nach Hause. Für Anna ist diese Zeit wie im Flug vergangen. Sie hat viele neue Freunde gefunden. Viele davon werden, wie sie, bald eine Lehre in einer der großen Fabriken anfangen. Anna hofft, dass sie sich vielleicht Briefe schreiben werden, falls sie nach der Arbeit dann noch Zeit und Kraft dafür finden wird. Zumindest fühlt sie sich nicht mehr so allein, denn sie weiß nun, dass es viele Kinder und Jugendliche gibt, denen es ähnlich geht wie ihr. Und sie alle hoffen auf eine bessere Zukunft für sich und ihre Familien.'
  ...
  render() {
    return (
      <Chapter class="food">
        ...
        <>
          <button type='button' className='link-button' onClick={() => this.setState({redirect: true})}>Ende</button>
          {this.state.redirect && <Redirect exact to={{ pathname: "/imprint", state: { ...this.state } }} />}
        </>
      </Chapter>
    );
  }
